...
<div class="about">
    <h2>O nás</h2>
<p>Detským táborom sa venujeme 12 rokov. Začali sme, keď boli naše deti ešte malé a dnes sa spolupodieľajú na prípravách a realizácii všetkých našich aktivít v Tábor, ktorú sme založili z túžby prispieť k výchove a vzdelávaniu detí a mládeže.</p>

<br>

<iframe src="https://www.youtube.com/embed/nkz64zp_F-I" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<br>
<h3>Náš tím</h3>
<div class="team">
    ...
    <p style="font-size: 18px;">školská psychologička a učiteľka etickej výchovy na SŠ</p>
    </div>
    <div style="flex: 1; text-align: center; font-family: 'Open Sans', sans-serif;">
    <p style="font-size: 30px; font-weight: normal; margin-top: 15px">J.</p>
    <p style="font-size: 18px;">pedagóg a dlhoročný tréner detí a mládeže</p>
    </div>
    </div>
