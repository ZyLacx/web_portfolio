...
<div class="camp">
    <div>
        ...
        <img style="width: 65%; margin: 0 auto;" src="files/jablko.png">
    </div>
    <div>
        <h1>Galérie</h1>
        <a href='?stranka=galeria&id=7'>
            <div style="width: 100%; display: flex; justify-content: center;">
                <img style="width: 250px;" src='files/jablko.png'>
            </div>
        </a>
        <a href='?stranka=galeria&id=1'>
            <div style="width: 100%; display: flex; justify-content: center;">
                <img style="width: 250px;" src='files/img/thumbnails/audio.png'>
            </div>
        </a>
    </div>
</div>